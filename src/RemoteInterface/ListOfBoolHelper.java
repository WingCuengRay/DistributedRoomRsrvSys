...
{
  private static String  _id = "IDL:RemoteInterface/ListOfBool:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (RemoteInterface.ListOfBoolHelper.id (), "ListOfBool", __typeCode);
    }
    return __typeCode;
  }
